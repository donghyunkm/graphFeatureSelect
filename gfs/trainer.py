...
from gfs.datamodule import AnnDataGraphDataModule
from gfs.models import GNN, GNN_concrete
...
if model_type == "concrete" or model_type == "gnn":
    datamodule = AnnDataGraphDataModule(
        data_dir=paths["data_root"], file_names=["VISp_nhood.h5ad"], batch_size=1, n_hops=2
    )
elif model_type == "persist":
    datamodule = AnnDataGraphDataModule(
        data_dir=paths["data_root"], file_names=["VISp_nhood.h5ad"], batch_size=512, n_hops=2, no_edges=True
    )
